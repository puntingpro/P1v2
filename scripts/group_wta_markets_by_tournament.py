...
# Load metadata
df = pd.read_csv("parsed/betfair_wta_markets_2023.csv", parse_dates=["market_time"])
...
# Save output
out_path = "parsed/betfair_wta_tournament_summary.csv"
Path("parsed").mkdir(exist_ok=True)
grouped.to_csv(out_path, index=False)
print(f"✅ Saved WTA tournament summary to {out_path}")
